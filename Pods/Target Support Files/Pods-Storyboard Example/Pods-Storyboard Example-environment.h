...
// DynamicXray
#define COCOAPODS_POD_AVAILABLE_DynamicXray
#define COCOAPODS_VERSION_MAJOR_DynamicXray 0
#define COCOAPODS_VERSION_MINOR_DynamicXray 2
#define COCOAPODS_VERSION_PATCH_DynamicXray 0
...
#define COCOAPODS_VERSION_PATCH_Reveal_iOS_SDK 5
